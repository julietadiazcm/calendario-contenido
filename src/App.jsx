...
const ACCOUNTS = [
  ...
  { id:"mariano", name:"Mariano Magicaldreamakers", shortName:"Mariano", emoji:"🏰", description:"Viajes a Disney & Universal · Asesoría de viaje", brand:{ primary:"#6FA8DC", primarySoft:"#bcd9f0", accent:"#E8B84B", text:"#1c2330", white:"#FFFFFF", bg:"#EFF5FB", cardBg:"#FFFFFF", sidebar:"#1c2330", sidebarText:"#9fc6ea", btnBg:"#6FA8DC", btnText:"#FFFFFF", inputBorder:"#6FA8DC", fontTitle:"'Georgia',serif", fontBody:"'Trebuchet MS',sans-serif", tagline:"Tu próximo viaje a Disney empieza con una buena planificación." }, brandKit:{ audience:"Familias que están pensando o planificando un viaje a Disney o Universal.", objective:"Generar consultas y asesorías de viaje, posicionar a Mariano como experto en planificación.", tone:"Cercano, confiable, experto, sin tecnicismos, hablando directamente a las dudas de las familias.", wordsYes:"planificación, asesoría, familia, tranquilidad, experiencia, Assist Card", wordsNo:"urgencia falsa, promesas exageradas, tecnicismos de la industria", instagram:"", whatsapp:"", drive:"", canva:"", website:"", notes:"Trabaja mucho con storytelling personal y objeciones económicas. Partner recurrente: Assist Card (seguro de viaje)." } },
];
